...
$erro[] = Documento::Local("api/dao")->Tipo('dao')->Arquivos(["Autores","Usuarios","Mangas","Generos","Generos_Mangas","Avaliacoes","Favoritos","Comentarios_Manga","Capitulos"])->Exec();
$erro[] = Documento::Local("api/controller")->Tipo('controller')->Arquivos(["Autores","Usuarios","Mangas","Generos","Generos_Mangas","Avaliacoes","Favoritos","Comentarios_Manga","Capitulos"])->Exec();
$erro[] = Documento::Local("api/service")->Tipo('service')->Arquivos(["Autores","Usuarios","Mangas","Generos","Generos_Mangas","Avaliacoes","Favoritos","Comentarios_Manga","Capitulos"])->Exec();
