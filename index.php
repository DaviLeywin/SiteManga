...
// $erro[] = Documento::Local("api/service")->Tipo('service')->Arquivos(["Rankings","Autores","Usuarios","Mangas","Generos","Generos_Mangas","Avaliacoes","Favoritos","Comentarios_Manga","Capitulos"])->Exec();
