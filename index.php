...
// Documentos::C_arquivos(caminho:"api/services/generos_mangasService",arquivos:["PostService.php","DeleteService.php","PutService.php","GetService.php"]);
// Documentos::C_arquivos(caminho:"api/services/generosService",arquivos:["PostService.php","DeleteService.php","PutService.php","GetService.php"]);
