...
class Capitulos {
    ...
    function AlterarMangasId(int $MangasId){
        if(!BaseValidator::ValidarPositivoInteiro($MangasId)){
            throw new InvalidArgumentException("MANGA_ID tem que ser um numero inteiro positivo maior que zero!");
        }
    ...
    function GetSinopse(){ return $this->MANGAS_ID;}

    function GetDataLancamento(){ return $this->NUMERO_CAPITULO;}

    function GetTituloCapitulo(){ return $this->TITULO_CAPITULO;}

    function GetNumeroCapitulo(){ return $this->DATA_LANCAMENTO;}

    function GetMangasId(){ return $this->SINOPSE;}
